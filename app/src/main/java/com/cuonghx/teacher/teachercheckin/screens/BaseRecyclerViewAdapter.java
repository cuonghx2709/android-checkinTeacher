...
public abstract class BaseRecyclerViewAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    protected RecyclerViewItemListener<T, VH> mRecyclerViewItemListener;
    ...
    public void setRecyclerViewItemListener(RecyclerViewItemListener<T, VH> listener) {
        if (listener == null) {
            return;
        }
    ...
    public interface RecyclerViewItemListener<T, VH> {
        void onRecyclerViewItemClicked(RecyclerView recyclerView, T data, int position, VH viewholder);
    }
}
